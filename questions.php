...
$qno = $_GET['qno'];
// echo $qno;
$qry2 = $conn->prepare("select * from question where qclass='" . $_SESSION['class'] . "' and id='$qno' order by Rand() limit 1 ");
...
$sql = $conn->prepare("select * from testattempt where stdid=" . $_SESSION['stdid'] . " and testid=" . $_SESSION['testid'] . " and quid='$qno'");
$numrows2 = $sql->rowCount($sql);
$sql->execute();
...
//$qry3=$conn->prepare("insert into testattempt(stdid,testid,quid) values(".$_SESSION['stdid'].",'121',".$fetch['id'].")")
?>
